...
def scrapping(collection, tickers_list, last_day, t, error_t):
    ...
    for tick in tickers_list:
        ...
        #for i in range(0, 100000000):
            if maxid is None:  #get last batch of twits about Apple (latest id)
...
#                    url = f"https://api.stocktwits.com/api/2/streams/symbol/{tick}.json"
            ...
            if prev_id < maxid: #BRK error: 1st twit aftercutoff date, so loop restarts scrapping from the top.
